...
import org.jeecg.modules.demo.test.entity.TestNote;
import org.jeecg.modules.demo.test.service.ITestNoteService;
...
public class TestNoteController extends JeecgController<TestNote, ITestNoteService> {
	...
	@RequiresPermissions("test:test_note:add")
	...
	@RequiresPermissions("test:test_note:edit")
	...
	@RequiresPermissions("test:test_note:delete")
	...
	@RequiresPermissions("test:test_note:deleteBatch")
    ...
    * @param testNote
    */
    @RequiresPermissions("test:test_note:exportXls")
    ...
    * @return
    */
    @RequiresPermissions("test:test_note:importExcel")
